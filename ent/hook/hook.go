...
type PinFunc func(context.Context, *ent.PinMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f PinFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.PinMutation)
	if !ok {
