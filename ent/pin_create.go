...
func (pc *PinCreate) check() error {
	if _, ok := pc.mutation.CreateTime(); !ok {
		return &ValidationError{Name: "create_time", err: errors.New(`ent: missing required field "Pin.create_time"`)}
	}
	if _, ok := pc.mutation.UpdateTime(); !ok {
		return &ValidationError{Name: "update_time", err: errors.New(`ent: missing required field "Pin.update_time"`)}
	}
	if _, ok := pc.mutation.Status(); !ok {
		return &ValidationError{Name: "Status", err: errors.New(`ent: missing required field "Pin.Status"`)}
	}
	...
	if _, ok := pc.mutation.Name(); !ok {
		return &ValidationError{Name: "Name", err: errors.New(`ent: missing required field "Pin.Name"`)}
	}
	...
	if _, ok := pc.mutation.CID(); !ok {
		return &ValidationError{Name: "CID", err: errors.New(`ent: missing required field "Pin.CID"`)}
	}
...
func (pc *PinCreate) createSpec() (*Pin, *sqlgraph.CreateSpec) {
	...
	if value, ok := pc.mutation.CreateTime(); ok {
		_spec.SetField(pin.FieldCreateTime, field.TypeTime, value)
...
func (u *PinUpsertOne) UpdateNewValues() *PinUpsertOne {
	...
	u.create.conflict = append(u.create.conflict, sql.ResolveWith(func(s *sql.UpdateSet) {
		if _, exists := u.create.mutation.CreateTime(); exists {
			s.SetIgnore(pin.FieldCreateTime)
		}
	}))
	return u
}
