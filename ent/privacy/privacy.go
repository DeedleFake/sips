...
// The PinQueryRuleFunc type is an adapter to allow the use of ordinary
// functions as a query rule.
type PinQueryRuleFunc func(context.Context, *ent.PinQuery) error

// EvalQuery return f(ctx, q).
func (f PinQueryRuleFunc) EvalQuery(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.PinQuery); ok {
		return f(ctx, q)
	}
	return Denyf("ent/privacy: unexpected query type %T, expect *ent.PinQuery", q)
}

// The PinMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type PinMutationRuleFunc func(context.Context, *ent.PinMutation) error

// EvalMutation calls f(ctx, m).
func (f PinMutationRuleFunc) EvalMutation(ctx context.Context, m ent.Mutation) error {
	if m, ok := m.(*ent.PinMutation); ok {
		return f(ctx, m)
	}
	return Denyf("ent/privacy: unexpected mutation type %T, expect *ent.PinMutation", m)
}
